...
const logger_1 = require("../http/middlewares/logger");
...
exports.createEventHandler = (Clients, options) => {
    return (handler) => {
        ...
        const pipeline = [logger_1.logger, clients_1.clients(Clients, options), timings_1.timings, error_1.error, contextAdapter(middlewares)];
